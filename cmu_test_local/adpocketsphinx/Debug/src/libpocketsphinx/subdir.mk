...
src/libpocketsphinx/%.o: ../src/libpocketsphinx/%.c
	...
	gcc -I/home/q/Workspace/cmu_test_local/adsphinxbase/include/ -I/home/q/Workspace/cmu_test_local/adpocketsphinx/include/ -O0 -g3 -Wall -c -fmessage-length=0 -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
